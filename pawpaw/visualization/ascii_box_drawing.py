...
class Corner:
    ...
    _characters: typing.Dict[str, typing.Tuple[Orientation, Style]] = {
        ...
        '╓': (Orientation.NW, Style(), Style(count=Style.Count.DOUBLE_DASH)),
        '╒': (Orientation.NW, Style(count=Style.Count.DOUBLE), Style()),
        '╔': (Orientation.NW, Style(count=Style.Count.DOUBLE), Style(count=Style.Count.DOUBLE)),
        ...
        '╖': (Orientation.NE, Style(), Style(count=Style.Count.DOUBLE_DASH)),
        '╕': (Orientation.NE, Style(count=Style.Count.DOUBLE), Style()),
        '╗': (Orientation.NE, Style(count=Style.Count.DOUBLE), Style(count=Style.Count.DOUBLE)),
        ...
        '╙': (Orientation.SW, Style(), Style(count=Style.Count.DOUBLE_DASH)),
        '╘': (Orientation.SW, Style(count=Style.Count.DOUBLE), Style()),
        '╚': (Orientation.SW, Style(count=Style.Count.DOUBLE), Style(count=Style.Count.DOUBLE)),
        ...
        '╜': (Orientation.SE, Style(), Style(count=Style.Count.DOUBLE_DASH)),
        '╛': (Orientation.SE, Style(count=Style.Count.DOUBLE), Style()),
        '╝': (Orientation.SE, Style(count=Style.Count.DOUBLE), Style(count=Style.Count.DOUBLE)),
    }
