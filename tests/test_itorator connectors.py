...
class TestItoratorConnections(_TestIto):
    def test_yield_break(self):
        ...
        itor_1.connections.append(Connectors.Next(itor_2))
        itor_1.connections.append(Connectors.Next(itor_3))
        rv = [*itor_1(root)]
        ...
        itor_1.connections.append(Connectors.Next(itor_2))
        itor_2.connections.append(Connectors.Next(itor_3))
        rv = [*itor_1(root)]
    ...
    def test_assign(self):
        ...
        itor_1.connections.append(Connectors.Sub(itor_3))
        rv = [*itor_1(root)]
        ...
        itor_1.connections.clear()
        itor_1.connections.append(Connectors.Sub(itor_2))
        itor_2.connections.append(Connectors.Sub(itor_3))
        rv = [*itor_1(root)]
    ...
    def test_sub(self):
        ...
        itor_1.connections.append(Connectors.Xxx(itor_2))
        rv = [*itor_1(root)]
